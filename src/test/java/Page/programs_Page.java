...
public class programs_Page {
    ...
    @FindBy(xpath = "//label[@for='videoGuideFileInput']")
    public WebElement videoInstructionButton;
    @FindBy(xpath = "//label[@for='guideFileInput']")
    public WebElement instructionButton;
    @FindBy(xpath = "//label[@for='otherFileInput']")
    public WebElement anotherInstructionButton;
    @FindBy(xpath = "//span[contains(.,'Yadda saxla')]")
    public WebElement saveButton;
    // "//button[@class='mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base']//span[text()='Yadda saxla']")
