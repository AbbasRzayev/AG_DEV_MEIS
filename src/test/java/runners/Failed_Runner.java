...
@CucumberOptions(  //plugin kismi raporlar icin
       ...
       // monochrome = true, //console okunakli hale getirir, renksiz yapar
        features = "@TestOutput/failed_Scenario.txt", //testcase'lerimizin olduğu directory yolu verilir
//stepdefinitions package yolu verilir, metotlarımızı okuması için
        glue = {"stepdefinitions", "hooks"}, //runners ise Hooks.class yolu olarak verilir
        /* 1-Bu parametre ile kodlarımızı yazdığımız stepDefinition class'ının packege'ını belirtiriz
2- Hooks classin yolunu veririz.
                                             */
//        tags = "@structure_and_duties",
        dryRun = false,
