...
Feature: Request deadline
  ...
  Scenario: Check if the executor can declines the execution of the request
    ...
    Then the executors name and the date the request was accepted and the execution status  are "Müddəti bitib" displayed
    ...
    And adds id to the id filter
    When user selects enter in the users tab
    Then current "Müddəti bitib" result is displayed
    ...
    And all the information is displayed about decline request in the notification sent to the person who initiated the execution
      ...
      | Digər problemlər | Yüksək    | İcradan imtina edilib | İcra tarixi bitmişdir | İbrahim Rzayev | Davud Zamanov | PC_7788              |
    #Test ssenarilər:
    #106.İcraçı müraciətə icra barədə qeyd əlavə edərək statusunu 'Müddəti bitib' olaraq dəyişməsi
    #107.Müraciətin baxış hissəsində icra haqqında(Müddəti bitib) təsvir melumatların əks olunmasının yoxlanılması
    #108.Bildirişin cari nəticəsinin dəyişdirilməsi modal pəncərəsində, proqres barın 100 faiz edilərək qeydin əlavə edilməsi
    #109.Müraciətin baxış hissəində, proqres barın və qeydin yoxlanılması
    #110.Müraciətin "Müddəti bitib" statusu və icraçı barədə məlumatların ümumi cədvəldə yoxlanılması
    #111.Müraciətin statusu 'Müddəti bitib' olduqda, sistemə müraciəti daxil edən şəxsə bildiriş göndərib-göndərmədiyi yoxlanılması
    #112.Sistemə müraciəti daxil edən şəxsin sistem üzrə bütün bildiriş məlumatlarının yoxlanması yoxlanılması